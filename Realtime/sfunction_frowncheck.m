%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: The s-function to detect frown in real time
%--------------------------------------------------------------------------------------------------------------------------------
...
function [sys,x0,str,ts] = sfunction_frowncheck(t,x,u,flag,windowlength,Vcl,Vop,Amin)
DelayBegin=20;
...
elseif flag==2
    ...
    if x(2) ~= 0
        ...
        blkf = EOG_getpeak(data, 32, Vcl,Vop,Amin, 0.4, 2, 10, 0);
