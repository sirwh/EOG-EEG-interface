%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: The s-function to create a ERP interface. 
% It is used to control robots (Kobuki) in real time (by ERP command) in our experiment.
% It also provides a visual output in the "display" block, and a file output of Data.txt. 
% Please only modify Line 335~372, if the control commands need to be modified.
%--------------------------------------------------------------------------------------------------------------------------------
    ...
    case 2      % Update of discrete states
        ...
        if any(get(0,'Children')==fig)       % is fig a 'Child' of the root object?
            if strcmp(get(fig,'Name'),'BCI P300 Matrix Speller - Single Character Flash'),
                ...
                %% Ma: if it is not P300 mode, repeatedly begin a new trial to prevent any output
                %                 mov = ALBehaviorManagerProxy(handles.ip,9559);
                %                 rb = mov.getRunningBehaviors();
                %
                if u(3)==0 %|| ~isempty(rb)
                    handles.newtrial=true;
                    %handles.stop=true;
                    set(handles.flashImg, 'Visible','off');
                    set(handles.targImg,'Visible','off');
                    set(handles.dirImg,'Visible','off');
                end
                %%
                stop = u(1);
                if stop ~= 0
                    ...
                    if ~handles.waitNextTrial     % false...Trial not ready
                        ...
                        if handles.targetoff
                            ...
                            if handles.stop == true
                               ...
                               %% Ma: if an EOG label is detected before the P300 result comes out, ignore it
                                    if u(3)==2 
                                    ...
                                    %                                     %% robot control
                                    %                                     if solIndex ~=99
                                    % %                                         tts = ALTextToSpeechProxy(handles.ip,9559);
                                    %                                         switch handles.result
                                    %                                             case 1
                                    %                                                 jtcp('write',jTcpObj,'P300 1');
                                    %                                             case 2
                                    %                                                 jtcp('write',jTcpObj,'P300 2');
                                    %                                                 %RunBehavior(handles.ip, 'dance');
                                    % %                                                 tts.say('goodbye');
                                    %                                             case 3
                                    %                                                 jtcp('write',jTcpObj,'P300 3');
                                    % %                                                 tts.say('output 3');
                                    %                                             case 4
                                    %                                                 jtcp('write',jTcpObj,'P300 4');
                                    % %                                                 tts.say('output 4');
                                    %                                             case 5
                                    %                                                 jtcp('write',jTcpObj,'P300 5');
                                    % %                                                 tts.say('output 5');
                                    %                                             case 6
                                    %                                                 jtcp('write',jTcpObj,'P300 6');
                                    % %                                                 tts.say('output 6');
                                    %                                             case 7
                                    %                                                 jtcp('write',jTcpObj,'P300 7');
                                    % %                                                 tts.say('output 7');
                                    %                                             case 8
                                    %                                                 jtcp('write',jTcpObj,'P300 8');
                                    % %                                                 tts.say('output 8');
                                    %                                             otherwise
                                    %                                         end
                                    %                                     end
                     ...
                     %% Ma: use EOG label to stop incorrect output
                        if t>handles.starttimeTrial
                            if u(3)==2 && handles.trialwaitTime2==0 %find EOG
                                handles.trialwaitTime2=t-handles.starttimeTrial;
                                fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 cancel\n',t); fclose(fid);
                            end
                            if t>handles.starttimeTrial+handles.trialwaitTime+handles.trialwaitTime2
                                if handles.trialwaitTime2==0 % execute command
                                    switch handles.result
                                        case 1
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 1' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','off','r2','off','r3','off','r4','off','r5','off');
%                                             set_param('P300_directions/robot','r1','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 1\n',t); fclose(fid);
                                        case 2
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 2' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','off','r2','off','r3','off','r4','off','r5','off');
%                                             set_param('P300_directions/robot','r2','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 2\n',t); fclose(fid);
                                        case 3
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 3' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','off','r2','off','r3','off','r4','off','r5','off');
%                                             set_param('P300_directions/robot','r3','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 3\n',t); fclose(fid);
                                        case 4
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 4' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','off','r2','off','r3','off','r4','off','r5','off');
%                                             set_param('P300_directions/robot','r4','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 4\n',t); fclose(fid);
                                        case 5
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 5' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','off','r2','off','r3','off','r4','off','r5','off');
%                                             set_param('P300_directions/robot','r5','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 5\n',t); fclose(fid);
                                        case 6
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 6' char(39) ');'])
%                                             set_param('P300_directions/robot','r1','on','r2','on','r3','on','r4','on','r5','on');
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 6\n',t); fclose(fid);
                                        case 7
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 7' char(39) ');'])
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 7\n',t); fclose(fid);
                                        case 8
                                            set_param('P300_directions/Display','BackgroundColor','[0 1 0]','MaskDisplay', ['disp(' char(39) 'P300 8' char(39) ');'])
                                            fid=fopen('Data.txt','a'); fprintf(fid,'%f P300 8\n',t); fclose(fid);
                                        otherwise
                                    end
                                end
                                % other code
