...
% The center of the interval is a local maximal value on original EOG. Then mark the result on the figure of EOG data.
%--------------------------------------------------------------------------------------------------------------------------------
...
function [record difrecord] = getrecording(data, trail, fs, dur)
% dur: the length of the interval to retrieve
% record: intervals retrieved from orignal EOG
% difrecord: intervals retrieved from differentiated EOG
